...
def get_category_keyboard():
    ...
    builder.row(
        InlineKeyboardButton(text="Сотрудник", callback_data="category_employee")
    )
    builder.row(
        InlineKeyboardButton(text="Внешний донор", callback_data="category_external")
    )
    return builder.as_markup()
...
def get_consent_keyboard():
    ...
    builder = InlineKeyboardBuilder()
    builder.row(
        InlineKeyboardButton(text="✅ Принимаю условия", callback_data="consent_given")
    )
    return builder.as_markup()
...
def get_student_main_menu(viewer_role: str = "student"):
    ...
    builder.row(
        InlineKeyboardButton(
            text="📅 Записаться на донацию", callback_data="register_donation"
        )
    )
    ...
    builder.row(
        InlineKeyboardButton(text="⚕️ Мои медотводы", callback_data="my_waivers")
    )
    builder.row(
        InlineKeyboardButton(
            text="❓ Задать вопрос организаторам", callback_data="ask_question"
        )
    )
    ...
    if viewer_role == "volunteer":
        builder.row(
            InlineKeyboardButton(
                text="⭐ Вернуться в меню волонтера", callback_data="volunteer_panel"
            )
        )
        ...
        builder.row(
            InlineKeyboardButton(
                text="⚙️ Вернуться в админ-панель", callback_data="admin_panel"
            )
        )
...
def get_volunteer_main_menu(viewer_role: str = "volunteer"):
    builder = InlineKeyboardBuilder()
    builder.row(
        InlineKeyboardButton(text="⭐ Меню волонтёра", callback_data="volunteer_panel")
    )
    builder.row(
        InlineKeyboardButton(
            text="👤 Перейти в режим донора", callback_data="switch_to_donor_view"
        )
    )
    return builder.as_markup()
...
def get_main_admin_main_menu(viewer_role: str = "main_admin"):
    ...
    builder.row(
        InlineKeyboardButton(
            text="⚙️ Открыть панель администратора", callback_data="admin_panel"
        )
    )
    return builder.as_markup()
...
def get_profile_menu_keyboard():
    ...
    builder.row(
        InlineKeyboardButton(text="🩸 История донаций", callback_data="profile_history")
    )
    builder.row(
        InlineKeyboardButton(text="↩️ В главное меню", callback_data="back_to_main_menu")
    )
...
def get_back_to_profile_menu_keyboard():
    builder = InlineKeyboardBuilder()
    builder.row(
        InlineKeyboardButton(text="↩️ Назад в профиль", callback_data="my_profile")
    )
    return builder.as_markup()
...
def get_info_menu_keyboard():
    builder = InlineKeyboardBuilder()
    builder.row(
        InlineKeyboardButton(text="Как подготовиться?", callback_data="info_prepare")
    )
    builder.row(
        InlineKeyboardButton(
            text="Противопоказания", callback_data="info_contraindications"
        )
    )
    builder.row(
        InlineKeyboardButton(text="Что делать после?", callback_data="info_after")
    )
    builder.row(
        InlineKeyboardButton(
            text="🩸 О донорстве костного мозга (ДКМ)", callback_data="info_dkm"
        )
    )
    builder.row(
        InlineKeyboardButton(
            text="🏥 О донациях в МИФИ", callback_data="info_mifi_process"
        )
    )
    builder.row(
        InlineKeyboardButton(
            text="Связаться с организаторами", callback_data="info_contacts"
        )
    )
    builder.row(
        InlineKeyboardButton(text="↩️ В главное меню", callback_data="back_to_main_menu")
...
def get_purchase_confirmation_keyboard(item_id: int):
    ...
    builder.row(
        InlineKeyboardButton(
            text="✅ Подтвердить", callback_data=f"confirm_buy_{item_id}"
        ),
...
def get_admin_panel_keyboard(viewer_role: str):
    ...
    builder.row(
        InlineKeyboardButton(
            text="🗓️ Упр. мероприятиями", callback_data="admin_manage_events"
        )
    )
    builder.row(
        types.InlineKeyboardButton(
            text="❓ Вопросы от пользователей", callback_data="admin_answer_questions"
        )
    )
    builder.row(
        InlineKeyboardButton(
    ...
    builder.row(
        InlineKeyboardButton(
            text="📝 Ред. инфо-разделы", callback_data="admin_edit_info"
        )
    )
    if viewer_role == "main_admin":
        builder.row(
            types.InlineKeyboardButton(
                text="💾 Экспорт данных", callback_data="ma_export_data"
            ),
            types.InlineKeyboardButton(
                text="📥 Импорт данных", callback_data="ma_import_data"
            ),
        )
        builder.row(
            types.InlineKeyboardButton(
                text="📥 Импорт старой БД", callback_data="ma_import_old_db"
            )
        )
    builder.row(
        InlineKeyboardButton(
...
def get_analytics_main_menu_keyboard():
    ...
    builder.row(
        InlineKeyboardButton(
            text="📈 Общая статистика (KPI)", callback_data="analytics_kpi"
        )
    )
    builder.row(
        InlineKeyboardButton(
            text="📅 Анализ мероприятий", callback_data="analytics_events_select"
        )
    )
    builder.row(
...
def get_reports_menu_keyboard():
    ...
    builder.row(
        InlineKeyboardButton(
            text="Доноры-однодневки", callback_data="report_churn_donors"
        )
    )
    builder.row(
        InlineKeyboardButton(
            text="Угасающие доноры", callback_data="report_lapsed_donors"
        )
    )
    builder.row(
        InlineKeyboardButton(text="Топ-20 доноров", callback_data="report_top_donors")
    )
    ...
    builder.row(
        InlineKeyboardButton(
            text="Кандидаты в регистр ДКМ", callback_data="report_dkm_candidates"
        )
    )
    # III. Отчеты по конверсии и эффективности
    builder.row(
        InlineKeyboardButton(
            text="Потеря после опросника", callback_data="report_survey_dropoff"
        )
    )
...
def get_events_management_keyboard():
    ...
    builder.row(
        InlineKeyboardButton(
            text="➕ Создать мероприятие", callback_data="admin_create_event"
        )
    )
    builder.row(
        InlineKeyboardButton(
            text="📜 Просмотр/Редактирование активных",
            callback_data="admin_view_events",
        )
    )
...
def get_single_event_management_keyboard(
    event_id: int, registration_is_open: bool, has_feedback: bool = False
):
    builder = InlineKeyboardBuilder()
    builder.row(
        InlineKeyboardButton(
            text="✏️ Редактировать", callback_data=f"admin_edit_event_{event_id}"
        )
    )
    reg_status_text = (
        "🔒 Закрыть регистрацию" if registration_is_open else "🔓 Открыть регистрацию"
    )
    builder.row(
        InlineKeyboardButton(
            text=reg_status_text, callback_data=f"admin_toggle_reg_{event_id}"
        )
    )
    builder.row(
        InlineKeyboardButton(
            text="👥 Список участников (.csv)",
            callback_data=f"admin_event_participants_{event_id}",
        )
    )
    builder.row(
        InlineKeyboardButton(
            text="🚨 Отменить мероприятие",
            callback_data=f"admin_cancel_event_{event_id}",
        )
    )
    if has_feedback:
        builder.row(
            InlineKeyboardButton(
                ...
                callback_data=f"admin_view_feedback_{event_id}",
            )
        )
    builder.row(
        InlineKeyboardButton(
            text="↩️ К списку мероприятий", callback_data="admin_view_events"
        )
    )
    return builder.as_markup()
...
def get_back_to_admin_panel_keyboard():
    ...
    builder.row(
        InlineKeyboardButton(
            text="↩️ В панель администратора", callback_data="admin_panel"
        )
    )
    return builder.as_markup()
...
def get_user_management_keyboard(
    target_user_id: int, target_user_role: str, viewer_role: str, is_blocked: bool
):
    builder = InlineKeyboardBuilder()
    builder.row(
        InlineKeyboardButton(
    ...
    builder.row(
        InlineKeyboardButton(
            text="🎟️ Упр. регистрациями",
            callback_data=f"admin_manage_user_regs_{target_user_id}",
        )
    )
    builder.row(
        InlineKeyboardButton(
            text="⚕️ Упр. медотводами",
            callback_data=f"admin_manage_waivers_{target_user_id}",
        )
    )
    ...
    if target_user_role == "student":
        builder.row(
            InlineKeyboardButton(
                text="⭐ Назначить волонтером",
                callback_data=f"admin_promote_volunteer_{target_user_id}",
            )
        )
    elif target_user_role == "volunteer":
        builder.row(
            InlineKeyboardButton(
                text="🧑‍🎓 Снять с должности волонтера",
                callback_data=f"admin_demote_volunteer_{target_user_id}",
            )
        )
    ...
    if viewer_role == "main_admin" and target_user_role != "main_admin":
        if target_user_role == "admin":
            builder.row(
                InlineKeyboardButton(
                    text="👑➖ Разжаловать админа",
                    callback_data=f"ma_demote_admin_{target_user_id}",
                )
            )
        else:
            builder.row(
                InlineKeyboardButton(
                    ...
                    callback_data=f"ma_promote_admin_{target_user_id}",
                )
            )
        if is_blocked:
            builder.row(
                InlineKeyboardButton(
                    text="✅ Разблокировать",
                    callback_data=f"ma_unblock_user_{target_user_id}",
                )
            )
        else:
            builder.row(
                InlineKeyboardButton(
                    text="🚫 Заблокировать",
                    callback_data=f"ma_block_user_{target_user_id}",
                )
            )
    ...
    builder.row(
        InlineKeyboardButton(
            text="↩️ Назад к управлению", callback_data="admin_manage_users"
        )
    )
    return builder.as_markup()
...
def get_user_editing_keyboard(user_id: int):
    ...
    for field, name in fields.items():
        builder.row(
            InlineKeyboardButton(
                text=name, callback_data=f"edit_user_{user_id}_{field}"
            )
        )

    builder.row(
        InlineKeyboardButton(
            text="↩️ Назад к пользователю", callback_data=f"admin_show_user_{user_id}"
        )
    )
    return builder.as_markup()
...
def get_gender_selection_for_edit_keyboard(user_id: int):
    ...
    builder.row(
        InlineKeyboardButton(
            text="Мужской", callback_data=f"set_gender_{user_id}_male"
        ),
        InlineKeyboardButton(
            text="Женский", callback_data=f"set_gender_{user_id}_female"
        ),
    )
    builder.row(
        InlineKeyboardButton(text="↩️ Назад", callback_data=f"admin_edit_user_{user_id}")
    )
    return builder.as_markup()
...
def get_user_deletion_confirmation_keyboard(user_id: int):
    ...
    builder.row(
        InlineKeyboardButton(
            text="🗑️ Да, удалить", callback_data=f"admin_confirm_delete_user_{user_id}"
        ),
        InlineKeyboardButton(
            text="↩️ Нет, назад", callback_data=f"admin_show_user_{user_id}"
        ),
    )
    return builder.as_markup()
...
def get_blood_centers_keyboard(blood_centers, edit_mode=False):
    ...
    for center in blood_centers:
        builder.row(
            InlineKeyboardButton(
                text=center.name, callback_data=f"select_blood_center_{center.id}"
            )
        )

    callback_data = "add_new_blood_center_edit" if edit_mode else "add_new_blood_center"
    builder.row(
        InlineKeyboardButton(text="➕ Добавить новый", callback_data=callback_data)
    )
    return builder.as_markup()
...
def get_main_admin_panel_keyboard():
    ...
    builder.row(
        InlineKeyboardButton(
            text="👮‍♂️ Управление администраторами", callback_data="ma_manage_admins"
        )
    )
    builder.row(
        InlineKeyboardButton(
            text="🚫 Управление блокировками", callback_data="ma_manage_blocks"
        )
    )
    builder.row(
        InlineKeyboardButton(text="💾 Экспорт данных", callback_data="ma_export_data")
    )
    builder.row(
        InlineKeyboardButton(
            text="↩️ В панель администратора", callback_data="admin_panel"
...
def get_back_to_ma_panel_keyboard():
    ...
    builder.row(
        InlineKeyboardButton(
            text="↩️ В панель гл. администратора", callback_data="main_admin_panel"
        )
    )
    return builder.as_markup()
...
def get_admins_management_keyboard():
    ...
    builder.row(
        InlineKeyboardButton(
            text="➕ Назначить администратора", callback_data="add_admin"
        )
    )
    builder.row(
        InlineKeyboardButton(
            text="➖ Разжаловать администратора", callback_data="remove_admin"
        )
    )
...
def get_blocks_management_keyboard():
    ...
    builder.row(
        InlineKeyboardButton(
            text="🔒 Заблокировать пользователя", callback_data="block_user_start"
        )
    )
    builder.row(
        InlineKeyboardButton(
            text="🔓 Разблокировать пользователя", callback_data="unblock_user_start"
        )
    )
    builder.row(InlineKeyboardButton(text="↩️ Назад", callback_data="main_admin_panel"))
    return builder.as_markup()
...
def get_export_keyboard():
    ...
    builder.row(
        InlineKeyboardButton(
            text="Выгрузить пользователей (.csv)", callback_data="export_users_csv"
        )
    )
    builder.row(
        InlineKeyboardButton(
            text="Выгрузить донации (.csv)", callback_data="export_donations_csv"
        )
    )
    builder.row(InlineKeyboardButton(text="↩️ Назад", callback_data="main_admin_panel"))
    return builder.as_markup()
...
def get_event_cancellation_confirmation_keyboard(event_id: int):
    ...
    builder.row(
        InlineKeyboardButton(
            text="❌ Да, отменить", callback_data=f"admin_confirm_cancel_{event_id}"
        ),
        InlineKeyboardButton(
            text="↩️ Нет, назад", callback_data=f"admin_show_event_{event_id}"
        ),
    )
    return builder.as_markup()
...
def get_back_to_events_menu_keyboard():
    ...
    builder.row(
        InlineKeyboardButton(
            text="↩️ К управлению мероприятиями", callback_data="admin_manage_events"
        )
    )
    return builder.as_markup()
...
def get_merch_deletion_confirmation_keyboard(item_id: int):
    ...
    builder.row(
        InlineKeyboardButton(
            text="🗑️ Да, удалить", callback_data=f"admin_confirm_delete_merch_{item_id}"
        ),
        InlineKeyboardButton(
            text="↩️ Нет, назад", callback_data=f"admin_show_merch_{item_id}"
        ),
    )
    return builder.as_markup()
...
def get_back_to_merch_menu_keyboard():
    ...
    builder.row(
        InlineKeyboardButton(
            text="↩️ К управлению магазином", callback_data="admin_manage_merch"
        )
    )
    return builder.as_markup()
...
def get_already_registered_keyboard(event_id: int):
    ...
    builder.row(
        InlineKeyboardButton(
            text="❌ Отменить мою регистрацию", callback_data=f"cancel_reg_{event_id}"
        )
    )
    builder.row(
        InlineKeyboardButton(
            text="↩️ К списку мероприятий", callback_data="register_donation"
        )
    )
    return builder.as_markup()
...
def get_event_creation_confirmation_keyboard():
    ...
    builder.row(
        InlineKeyboardButton(
            text="✅ Создать и разослать", callback_data="confirm_create_event"
        )
    )
    builder.row(
        InlineKeyboardButton(text="❌ Отмена", callback_data="admin_manage_events")
    )
    return builder.as_markup()
...
def get_mailing_audience_keyboard(current_filters: dict = None):
    ...
    builder.row(
        InlineKeyboardButton(
            text="📢 Всем пользователям", callback_data="mail_filter_role_all"
        )
    )
    builder.row(
        InlineKeyboardButton(
            text="⭐ Волонтерам и админам", callback_data="mail_filter_role_volunteers"
        )
    )
    builder.row(
        InlineKeyboardButton(
            text="⚙️ Только администраторам", callback_data="mail_filter_role_admins"
        )
    )
    ...
    builder.row(
        InlineKeyboardButton(
            text="По участникам мероприятия", callback_data="mail_to_event_participants"
        )
    )
    ...
    if current_filters:
        builder.row(
            InlineKeyboardButton(
                text="✅ Готово (перейти к подтверждению)",
                callback_data="mail_audience_finish",
            )
        )
    ...
    if current_filters:
        builder.row(
            InlineKeyboardButton(
                text="🔄 Сбросить все фильтры", callback_data="mail_audience_reset"
            )
        )

    builder.row(
        InlineKeyboardButton(text="❌ Отмена рассылки", callback_data="admin_panel")
    )

    return builder.as_markup()


def get_dynamic_mailing_filter_keyboard(
    items: list[str], filter_key: str, back_callback: str
):
    """
    ...
    for item in items:
        builder.row(
            InlineKeyboardButton(
                text=item, callback_data=f"mail_filter_{filter_key}_{item}"
            )
        )
...
def get_mailing_confirmation_keyboard():
    ...
    builder.row(
        InlineKeyboardButton(
            text="🚀 Да, запустить рассылку", callback_data="confirm_mailing"
        ),
        InlineKeyboardButton(
            text="✏️ Изменить текст", callback_data="edit_mailing_text"
        ),
...
def get_user_management_main_keyboard():
    ...
    builder.row(
        InlineKeyboardButton(
            text="📜 Список всех пользователей", callback_data="admin_users_list_page_1"
        )
    )
    builder.row(
        InlineKeyboardButton(
            text="🔍 Найти пользователя", callback_data="admin_search_user"
        )
    )
    builder.row(
        InlineKeyboardButton(
            text="➕ Добавить пользователя вручную",
            callback_data="admin_add_user_start",
        )
    )
    builder.row(
...
def get_users_list_pagination_keyboard(page: int, total_pages: int):
    ...
    if page > 1:
        nav_buttons.append(
            InlineKeyboardButton(
                text="◀️", callback_data=f"admin_users_list_page_{page - 1}"
            )
        )
    nav_buttons.append(
...
def get_successful_registration_keyboard(event_id: int):
    ...
    builder.row(
        InlineKeyboardButton(
            text="🗓️ Добавить в календарь", callback_data=f"add_to_calendar_{event_id}"
        )
    )
    builder.row(
        InlineKeyboardButton(
...
def get_donation_confirmation_keyboard(user_id: int, event_id: int):
    ...
    builder.row(
        ...
        InlineKeyboardButton(text="❌ Отмена", callback_data="volunteer_panel"),
    )
    return builder.as_markup()
...
def get_manual_registration_management_keyboard(user_id: int):
    ...
    builder.row(
        InlineKeyboardButton(
            text="➕ Записать на мероприятие",
            callback_data=f"admin_reg_start_{user_id}",
        )
    )
    builder.row(
        InlineKeyboardButton(
            text="➖ Отменить регистрацию",
            callback_data=f"admin_cancel_start_{user_id}",
        )
    )
    builder.row(
        InlineKeyboardButton(
...
def get_events_for_manual_registration_keyboard(user_id: int, events: list):
    ...
    builder.row(
        InlineKeyboardButton(
            text="↩️ Назад", callback_data=f"admin_manage_user_regs_{user_id}"
        )
    )
    return builder.as_markup()
...
def get_admin_waiver_management_keyboard(user_id: int, waivers: list):
    ...
    for waiver in waivers:
        ...
        reason_short = (
            (waiver.reason[:20] + "...") if len(waiver.reason) > 20 else waiver.reason
        )
    ...
    builder.row(
        InlineKeyboardButton(
            text="➕ Установить новый медотвод", callback_data=f"admin_waiver_{user_id}"
        )
    )
    builder.row(
        InlineKeyboardButton(
...
def get_feedback_well_being_keyboard():
    builder = InlineKeyboardBuilder()
    buttons = [
        InlineKeyboardButton(text=str(i), callback_data=f"fb_wb_{i}")
        for i in range(1, 6)
    ]
    builder.row(*buttons)
    return builder.as_markup()
...
def get_feedback_organization_keyboard():
    ...
    builder.row(
        *[
            InlineKeyboardButton(text=str(i), callback_data=f"fb_org_{i}")
            for i in range(1, 6)
        ]
    )
    builder.row(
...
def get_events_for_post_processing_keyboard(events: list):
    ...
    builder.row(
        types.InlineKeyboardButton(text="↩️ Назад", callback_data="admin_manage_events")
    )
    return builder.as_markup()


def get_participant_marking_keyboard(
    event_id: int, participants: list, marked_donations: set, marked_dkm: set
):
    ...
    builder.row(
        types.InlineKeyboardButton(
            text="✅ Сохранить изменения и завершить",
            callback_data=f"finish_marking_{event_id}",
        )
    )
    builder.row(
        types.InlineKeyboardButton(
            text="❌ Отмена", callback_data="admin_manage_events"
        )
    )
    return builder.as_markup()
