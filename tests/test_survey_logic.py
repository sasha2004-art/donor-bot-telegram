...
@pytest.mark.parametrize("modified_answer, user_gender, expected_status, expected_days, expected_reason_part", [
    ...
    ({"tooth_removal_last_10_days": "yes"}, "male", "temp_waiver", 10, "Удаление зуба"),
    ({"tattoo_or_piercing": "yes"}, "male", "temp_waiver", 120, "татуировки/пирсинга"),
    ({"antibiotics_last_2_weeks": "yes"}, "male", "temp_waiver", 14, "антибиотиков"),
    ...
    ({"has_hiv_or_hepatitis": "yes"}, "male", "temp_waiver", 365000, "Абсолютное противопоказание"),
    ({"has_cancer_or_blood_disease": "yes"}, "male", "temp_waiver", 365000, "Абсолютное противопоказание"),
    ({"has_chronic_disease": "yes"}, "male", "temp_waiver", 365000, "Абсолютное противопоказание"),
])
