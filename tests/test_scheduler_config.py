...
def test_setup_scheduler_adds_all_jobs():
    ...
    with patch('bot.utils.scheduler.AsyncIOScheduler') as mock_scheduler_class:
        ...
        assert found_waiver_job_call, "Задача check_waiver_expirations не была добавлена в планировщик"
        ...
        assert found_feedback_job_call, "Задача send_post_donation_feedback не была добавлена"